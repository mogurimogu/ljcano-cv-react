...
import { SiAdobeillustrator, SiAdobeindesign, SiAdobephotoshop, SiAffinitydesigner, SiAffinityphoto, SiAffinitypublisher, SiAngular, SiCanva, SiDocker, SiFigma, SiGithub, SiJavascript, SiJquery, SiMongodb, SiNodedotjs, SiReact, SiRedux, SiSass, SiSocketdotio } from "react-icons/si";
  ...
  const habilidades: Conocimientos[] = [
    {
      titulo: "Idiomas",
      habilidades: [
        { nombre: "Español", nivel: 100, icon: <img src={spain} alt="español"/> },
        { nombre: "Inglés", nivel: 50, icon: <img src={england} alt="español"/> },
        { nombre: "Catalán", nivel: 25, icon: <img src={catalonia} alt="español"/> },
      ],
    },
    {
      titulo: "Programación",
    ...
    },
    {
      ...
      habilidades: [
        ...
        { nombre: "Affinity Designer", nivel: 50, icon: <SiAffinitydesigner/> },
        { nombre: "Affinity Photo", nivel: 25, icon: <SiAffinityphoto/> },
        { nombre: "Affinity Publisher", nivel: 25, icon: <SiAffinitypublisher/> },
  ...
  return (
    <div>
      ...
      {habilidades.map((seccion, index) => (
        <section key={index}>
          <h2 className="text-center text-2xl font-medium p-3">{seccion.titulo}</h2>
